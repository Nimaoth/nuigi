...
when defined(emscripten):
  ...
  proc emscripten_set_main_loop*(f: proc() {.cdecl.}, fps: cint, simulate_infinite_loop: bool) {.importc: "emscripten_set_main_loop".}
  proc emscripten_cancel_main_loop*()  {.importc: "emscripten_cancel_main_loop".}
...
proc srand*(seed: uint64): void {.importc: "SDL_srand".}
proc rand*(n: int32): int32 {.importc: "SDL_rand".}
proc randf*(): float32 {.importc: "SDL_randf".}
proc randBits*(): uint32 {.importc: "SDL_rand_bits".}
proc randR*(state: ptr uint64, n: int32): int32 {.importc: "SDL_rand_r".}
proc randfR*(state: ptr uint64): float32 {.importc: "SDL_randf_r".}
proc randBitsR*(state: ptr uint64): uint32 {.importc: "SDL_rand_bits_r".}
...
proc getPointerProperty*(props: PropertiesID, name: cstring, default_value: nil pointer): nil pointer {.importc: "SDL_GetPointerProperty".}
...
type
  ...
  GPUColorTargetInfo* {.bycopy.} = object
    ...
    load_op*: GPULoadOp
    store_op*: GPUStoreOp
    resolve_texture*: nil GPUTexture
...
proc createGPUDevice*(format_flags: GPUShaderFormat, debug_mode: bool, name: nil cstring): GPUDevice {.importc: "SDL_CreateGPUDevice".}
...
proc beginGPURenderPass*(command_buffer: GPUCommandBuffer, color_target_infos: ptr GPUColorTargetInfo, num_color_targets: uint32, depth_stencil_target_info: nil ptr GPUDepthStencilTargetInfo): GPURenderPass {.importc: "SDL_BeginGPURenderPass".}
...
const HINT_MOUSE_DPI_SCALE_CURSORS* = "SDL_SDL_MOUSE_DPI_SCALE_CURSORS"
...
proc createAnimatedCursor*(frames: ptr CursorFrameInfo, frame_count: cint, hot_x: cint, hot_y: cint): Cursor {.importc: "SDL_CreateAnimatedCursor".}
...
proc createRenderer*(window: Window, name: nil cstring): Renderer {.importc: "SDL_CreateRenderer".}
proc createRendererWithProperties*(props: PropertiesID): Renderer {.importc: "SDL_CreateRendererWithProperties".}
proc createGPURenderer*(device: nil GPUDevice, window: nil Window): Renderer {.importc: "SDL_CreateGPURenderer".}
...
type
  GPURenderStateObj {.incompleteStruct.} = object
  GPURenderState* = ptr GPURenderStateObj

type GPURenderStateCreateInfo* {.bycopy.} = object
    fragment_shader*: GPUShader # The fragment shader to use when this render state is active
    num_sampler_bindings*: int32 # The number of additional fragment samplers to bind when this render state is active */
    sampler_bindings*: ptr GPUTextureSamplerBinding # Additional fragment samplers to bind when this render state is active */
    num_storage_textures*: int32 # The number of storage textures to bind when this render state is active */
    storage_textures*: ptr UncheckedArray[GPUTexture] # Storage textures to bind when this render state is active */
    num_storage_buffers*: int32 # The number of storage buffers to bind when this render state is active */
    storage_buffers*: ptr UncheckedArray[GPUBuffer] # Storage buffers to bind when this render state is active */
...
proc setGPURenderStateSamplerBindings*(state: GPURenderState, num_sampler_bindings: cint, sampler_bindings: ptr GPUTextureSamplerBinding): bool {.importc: "SDL_SetGPURenderStateSamplerBindings".}
proc setGPURenderStateStorageTextures*(state: GPURenderState, num_storage_textures: cint, storage_textures: ptr GPUTexture): bool {.importc: "SDL_SetGPURenderStateStorageTextures".}
proc setGPURenderStateStorageBuffers*(state: GPURenderState, num_storage_buffers: cint, storage_buffers: ptr GPUBuffer): bool {.importc: "SDL_SetGPURenderStateStorageBuffers".}
...
proc setGPURenderState*(renderer: Renderer, state: nil GPURenderState): bool {.importc: "SDL_SetGPURenderState".}
proc destroyGPURenderState*(state: GPURenderState): void {.importc: "SDL_DestroyGPURenderState".}
