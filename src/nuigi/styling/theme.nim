...
proc createThemeFromColor*(primary: UiColor): (seq[UiStyle], seq[UiNodeText]) =
  ...
  styles[int(UiStyleIndexTextField) - 1].fillColor = themeTint(h, 0.0'f32, 0.20'f32, 0.18'f32, 1.0'f32)
  styles[int(UiStyleIndexTextField) - 1].borderColor = themeTint(h, 0.0'f32, 0.18'f32, 0.48'f32, 1.0'f32)
  styles[int(UiStyleIndexTextFieldFocused) - 1].fillColor = themeTint(h, 0.0'f32, 0.18'f32, 0.22'f32, 1.0'f32)
