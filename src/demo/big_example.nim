...
proc buildFlexLayoutExamples*(b: var UiBuilder) =
  b.layoutVertical("flex-demos"):
    ...
    b.node("flex-anchor-ignored"):
      ...
      discard b.backgroundColor(rgba(0.17, 0.17, 0.17, 1.0))

      b.node:
        discard b.fit().padding(3).fontSize(12.0).flex(1.0, 1.0, 56.0).flexAlignSelf(flexAnchorIgnoredCurrentChildAlignSelf)
        discard b.fillBackground().backgroundColor(rgba(0.52, 0.78, 0.40, 1.0))
        discard b.text("left")
        b.node:
          ...
          discard b.fillBackground().backgroundColor(rgba(0.30, 0.52, 0.24, 1.0))
          for chip in ["Left1", "Left2", "Left3", "Left4", "Left5", "Left6", "Left7", "Left8", "Left9", "Left10", "Left11", "Left12"]:
            b.node:
              ...
              discard b.fillBackground().backgroundColor(rgba(0.22, 0.40, 0.20, 1.0))
              discard b.text(chip)
      ...
      b.node:
        ...
        discard b.fillBackground().backgroundColor(rgba(0.96, 0.82, 0.26, 1.0))
      ...
      b.node:
        ...
        discard b.fillBackground().backgroundColor(rgba(0.36, 0.56, 0.90, 1.0))
        ...
        b.node:
          ...
          discard b.fillBackground().backgroundColor(rgba(0.20, 0.36, 0.64, 1.0))
          for chip in ["Right1", "Right2", "Right3", "Right4", "Right5", "Right6", "Right7", "Right8", "Right9", "Right10", "Right11", "Right12"]:
            b.node:
              discard b.fit().padding(2).flex(0.0, 0.0, -1.0)
              discard b.fillBackground().backgroundColor(rgba(0.14, 0.28, 0.52, 1.0))
              discard b.text(chip)
    ...
    b.node("flex-anchor-ignored2"):
      ...
      b.node:
        ...
        b.node:
          ...
          discard b.textColor(rgba(0.92, 0.80, 0.80, 1.0)).wrapText()
    ...
    b.layoutHorizontal("flex-direction-row"):
      ...
      b.node:
        ...
        discard b.backgroundColor(rgba(0.40, 0.62, 0.90, 1.0))
      ...
      b.node:
        ...
        discard b.backgroundColor(rgba(0.38, 0.76, 0.52, 1.0))
    ...
    b.layoutHorizontal("flex-direction-row-reverse"):
      ...
      b.node:
        ...
        discard b.backgroundColor(rgba(0.42, 0.64, 0.92, 1.0))
      ...
      b.node:
        ...
        discard b.backgroundColor(rgba(0.50, 0.80, 0.48, 1.0))
    ...
    b.layoutHorizontal:
      ...
      b.node("flex-direction-column"):
        ...
        b.node:
          ...
          discard b.backgroundColor(rgba(0.44, 0.80, 0.56, 1.0))
      ...
      b.node("flex-direction-column-reverse"):
        ...
        b.node:
          ...
          discard b.backgroundColor(rgba(0.46, 0.68, 0.94, 1.0))
        ...
        b.node:
          ...
          discard b.backgroundColor(rgba(0.52, 0.82, 0.54, 1.0))
    ...
    b.layoutHorizontal("flex-wrap-align-content"):
      ...
      discard b.backgroundColor(rgba(0.16, 0.20, 0.28, 1.0))
      for i in 0 .. 8:
        b.node:
          ...
          discard b.backgroundColor(rgba(0.35 + i.float32 * 0.05'f32, 0.44, 0.76 - i.float32 * 0.04'f32, 1.0))
    ...
    b.layoutHorizontal("flex-wrap-reverse"):
      ...
      discard b.backgroundColor(rgba(0.22, 0.20, 0.16, 1.0))
      for i in 0 .. 6:
        b.node:
          ...
          discard b.backgroundColor(rgba(0.82 - i.float32 * 0.06'f32, 0.60, 0.34 + i.float32 * 0.05'f32, 1.0))
    ...
    b.layoutHorizontal("flex-align-items"):
      ...
      discard b.backgroundColor(rgba(0.14, 0.22, 0.20, 1.0))

      b.node:
        discard b.fit().padding(3).fontSize(10.0).flex(0.0, 1.0, 36.0).flexAlignSelf(flexAlignCurrentChildAlignSelf).fillBackground().backgroundColor(rgba(0.96, 0.70, 0.30, 1.0))
        discard b.text("A")

      b.node:
        discard b.fit().padding(3).fontSize(13.0).flex(0.0, 1.0, 36.0).flexAlignSelf(flexAlignCurrentChildAlignSelf)
        discard b.fillBackground().backgroundColor(rgba(0.90, 0.44, 0.50, 1.0))
        discard b.text("Align")

      b.node:
        discard b.fit().padding(3).fontSize(16.0).flex(0.0, 1.0, 36.0).flexAlignSelf(flexAlignCurrentChildAlignSelf)
        discard b.fillBackground().backgroundColor(rgba(0.40, 0.66, 0.94, 1.0))
        discard b.text("Tall")

      b.node:
        discard b.fit().padding(3).fontSize(11.0).flex(0.0, 1.0, 36.0).flexAlignSelf(flexAlignCurrentChildAlignSelf)
        discard b.fillBackground().backgroundColor(rgba(0.42, 0.82, 0.58, 1.0))
        discard b.text("S")

      b.node:
        discard b.fit().padding(3).fontSize(15.0).flex(0.0, 1.0, 36.0).flexAlignSelf(flexAlignCurrentChildAlignSelf)
        discard b.fillBackground().backgroundColor(rgba(0.74, 0.58, 0.96, 1.0))
        discard b.text("Base")
    ...
    b.layoutHorizontal("flex-child-props"):
      ...
      b.node:
        ...
        discard b.fillBackground().backgroundColor(rgba(0.40, 0.62, 0.90, 1.0))
      ...
      b.node:
        ...
        discard b.fillBackground().backgroundColor(rgba(0.42, 0.78, 0.52, 1.0))
...
proc buildGridLayoutExamples*(b: var UiBuilder) =
  b.layoutVertical("grid-demos"):
    discard b.fillX().fitY().padding(6).gap(6)
    discard b.backgroundColor(rgba(0.13, 0.17, 0.21, 1.0))
    ...
    b.node("grid-fixed-area"):
      ...
      discard b.backgroundColor(rgba(0.18, 0.20, 0.26, 1.0))

      b.node:
        discard b.gridJustifySelf(gridFixedCurrentJustifySelf).gridAlignSelf(gridFixedCurrentAlignSelf)
        discard b.gridArea(1, 1).fillBackground().backgroundColor(rgba(0.88, 0.46, 0.34, 1.0))
        discard b.text("A").fit()

      b.node:
        discard b.gridJustifySelf(gridFixedCurrentJustifySelf).gridAlignSelf(gridFixedCurrentAlignSelf)
        discard b.gridArea(2, 1, 2, 1).fillBackground().backgroundColor(rgba(0.40, 0.64, 0.90, 1.0))
        discard b.text("B span 2 cols").fit()

      b.node:
        discard b.gridJustifySelf(gridFixedCurrentJustifySelf).gridAlignSelf(gridFixedCurrentAlignSelf)
        discard b.gridArea(1, 2, 1, 1).fillBackground().backgroundColor(rgba(0.42, 0.80, 0.56, 1.0))
        discard b.text("C").fit()

      b.node:
        discard b.gridJustifySelf(gridFixedCurrentJustifySelf).gridAlignSelf(gridFixedCurrentAlignSelf)
        discard b.gridArea(2, 2, 2, 1).fillBackground().backgroundColor(rgba(0.74, 0.58, 0.96, 1.0))
    ...
    b.node("grid-fr-auto"):
      ...
      for labelText in ["one", "two wide", "three", "four", "five", "six"]:
        b.node:
          ...
          discard b.fillBackground().backgroundColor(rgba(0.34, 0.46, 0.78, 1.0))
    ...
    b.node("grid-self-align"):
      ...
      b.node:
        ...
        discard b.fillBackground().backgroundColor(rgba(0.36, 0.74, 0.80, 1.0))
        discard b.text("mix")
    ...
    b.node("grid-content-distribution"):
      ...
      discard b.backgroundColor(rgba(0.17, 0.18, 0.24, 1.0))
      ...
      b.node:
        ...
        discard b.fillBackground().backgroundColor(rgba(0.86, 0.40, 0.36, 1.0)).padding(5)
        discard b.text("span 2")
      b.node:
        discard b.gridJustifySelf(gridContentCurrentJustifySelf).gridAlignSelf(gridContentCurrentAlignSelf)
        discard b.gridArea(3, 1).fontSize(15.0)
        discard b.fillBackground().backgroundColor(rgba(0.40, 0.62, 0.90, 1.0)).padding(5)
        discard b.text("top")
      b.node:
        discard b.gridJustifySelf(gridContentCurrentJustifySelf).gridAlignSelf(gridContentCurrentAlignSelf)
        discard b.gridArea(1, 2, 3, 2)
        discard b.fillBackground().backgroundColor(rgba(0.42, 0.78, 0.52, 1.0)).padding(5)
...
proc buildTableLayoutExamples*(b: var UiBuilder) =
  b.layoutVertical("table-examples"):
    ...
    b.tableLayout([tableColumnFit(), tableColumnProportional(5), tableColumnProportional(1)], 4.0, 2.0):
      discard b.fillX().fitY()
      discard b.backgroundColor(rgba(0.08, 0.10, 0.14, 1.0))

      for h in ["Property", "Value", "Type"]:
        b.node:
          discard b.fitY().padding(5)
          discard b.fillBackground().backgroundColor(rgba(0.20, 0.25, 0.34, 1.0))
      ...
      let rowBg0 = rgba(0.12, 0.14, 0.19, 1.0)
      let rowBg1 = rgba(0.14, 0.17, 0.23, 1.0)
      for rowIdx in 0 ..< rowNames.len:
        ...
        b.node:
          ...
          discard b.textColor(rgba(0.52, 0.86, 0.56, 1.0))
        b.node:
          discard b.fitY().padding(4)
          discard b.fillBackground().backgroundColor(bg)
          discard b.text(rowTypes[rowIdx]).fit()
          discard b.textColor(rgba(0.56, 0.76, 0.96, 1.0))
    ...
    b.tableLayout([tableColumnFit(), tableColumnFill()], 6.0, 3.0):
      ...
      let kvBg0 = rgba(0.12, 0.14, 0.19, 1.0)
      let kvBg1 = rgba(0.14, 0.17, 0.23, 1.0)
      for i in 0 ..< kvKeys.len:
        ...
        b.node:
          ...
          discard b.textColor(rgba(0.60, 0.84, 0.60, 1.0))
