...
const
  FT_VALIDATE_feat* = (FT_VALIDATE_GX_START shl FT_VALIDATE_feat_INDEX)
  FT_VALIDATE_mort* = (FT_VALIDATE_GX_START shl FT_VALIDATE_mort_INDEX)
  FT_VALIDATE_morx* = (FT_VALIDATE_GX_START shl FT_VALIDATE_morx_INDEX)
  FT_VALIDATE_bsln* = (FT_VALIDATE_GX_START shl FT_VALIDATE_bsln_INDEX)
  FT_VALIDATE_just* = (FT_VALIDATE_GX_START shl FT_VALIDATE_just_INDEX)
  FT_VALIDATE_kern* = (FT_VALIDATE_GX_START shl FT_VALIDATE_kern_INDEX)
  FT_VALIDATE_opbd* = (FT_VALIDATE_GX_START shl FT_VALIDATE_opbd_INDEX)
  FT_VALIDATE_trak* = (FT_VALIDATE_GX_START shl FT_VALIDATE_trak_INDEX)
  FT_VALIDATE_prop* = (FT_VALIDATE_GX_START shl FT_VALIDATE_prop_INDEX)
  FT_VALIDATE_lcar* = (FT_VALIDATE_GX_START shl FT_VALIDATE_lcar_INDEX)
