...
proc FT_Get_Sfnt_Table*(face: FT_Face, tag: FT_Sfnt_Tag): pointer {.ftimport.}

proc FT_Load_Sfnt_Table*(face: FT_Face, tag: FT_ULong, offset: FT_Long,
  buffer: ptr FT_Byte, length: ptr FT_ULong): FT_Error {.ftimport.}

proc FT_Sfnt_Table_Info*(face: FT_Face, table_index: FT_UInt,
  tag: ptr FT_ULong, length: ptr FT_ULong): FT_Error {.ftimport.}

proc FT_Get_CMap_Language_ID*(charmap: FT_CharMap): FT_ULong {.ftimport.}

proc FT_Get_CMap_Format*(charmap: FT_CharMap): FT_Long {.ftimport.}
