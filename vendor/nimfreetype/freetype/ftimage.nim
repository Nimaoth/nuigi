...
const
  FT_GLYPH_FORMAT_NONE*      = ((0.culong shl 24) or (0.culong shl 16) or (0.culong shl 8) or (0.culong)).FT_Glyph_Format
  FT_GLYPH_FORMAT_COMPOSITE* = (('c'.culong shl 24) or ('o'.culong shl 16) or ('m'.culong shl 8) or ('p'.culong)).FT_Glyph_Format
  FT_GLYPH_FORMAT_BITMAP*    = (('b'.culong shl 24) or ('i'.culong shl 16) or ('t'.culong shl 8) or ('s'.culong)).FT_Glyph_Format
  FT_GLYPH_FORMAT_OUTLINE*   = (('o'.culong shl 24) or ('u'.culong shl 16) or ('t'.culong shl 8) or ('l'.culong)).FT_Glyph_Format
  FT_GLYPH_FORMAT_PLOTTER*   = (('p'.culong shl 24) or ('l'.culong shl 16) or ('o'.culong shl 8) or ('t'.culong)).FT_Glyph_Format
